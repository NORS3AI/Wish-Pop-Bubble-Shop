...
const D = DATA;
const BUILD = "v371"; // bump on each deploy; shown on the start screen to verify the live version
  ...
  html("scoop", `
    ...
    <div class="scoop-stage" id="scoop-stage">
      <div class="scoop-craft" id="scoop-craft">
        <div class="scoop-bowl" id="scoop-bowl" style="font-size:${Math.round(178 * ART.getScale("scoop_spoon"))}px">${ART.tag("scoop_spoon", "🥄")}<img class="art scoop-glitter-tip" id="scoop-glitter-tip" src="${ART.url("scoop_glitter_tip")}" alt="" draggable="false"></div>
