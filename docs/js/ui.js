...
const D = DATA;
const BUILD = "v100"; // bump on each deploy; shown on the start screen to verify the live version
...
function cakeDecoScale(n) { return ({ 3: 1.12, 5: 1.06, 6: 1.13, 7: 1.1, 8: 1.17 })[n] || 1.12; }
