...
const COURTYARD_CUSTOMERS = [
  ...
  { id: "prunella", name: "Prunella", emoji: "💜", location: "King's Courtyard", wishType: "c_Vanity",
    ...
    lines: ["Make me dazzling — the prince simply must notice ME, not my sister.",
      "Something glamorous, and prettier than whatever Griselda's getting.",
  ...
  { id: "griselda", name: "Griselda", emoji: "💚", location: "King's Courtyard", wishType: "c_Gala",
    line: "A charm for the gala — and do make it grander than Prunella's.",
    lines: ["A charm for the gala — and do make it grander than Prunella's.",
