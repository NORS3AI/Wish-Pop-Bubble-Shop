...
const COURTYARD_INGREDIENTS = [
  { id: "kc_pumpkin_nectar",  name: "Pumpkin Nectar",   qualities: ["Mirth", "Serenity"],    emoji: "🎃" },
  { id: "kc_slipper_sugar",   name: "Slipper Sugar",    qualities: ["Majesty", "Wisdom"],    emoji: "👠" },
  { id: "kc_frogmint",        name: "Frogmint",         qualities: ["Radiance", "Serenity"], emoji: "🌿" },
  { id: "kc_crownberries",    name: "Crownberries",     qualities: ["Glamour", "Majesty"],   emoji: "👑" },
  { id: "kc_moon_cream",      name: "Moon Cream",       qualities: ["Valor", "Radiance"],    emoji: "🌙" },
  { id: "kc_rose_cordial",    name: "Rose Cordial",     qualities: ["Honor", "Wisdom"],      emoji: "🌹" },
  { id: "kc_peacock_pepper",  name: "Peacock Pepper",   qualities: ["Fortune", "Glamour"],   emoji: "🦚" },
  { id: "kc_velvet_figs",     name: "Velvet Figs",      qualities: ["Mirth", "Fortune"],     emoji: "🍇" },
  { id: "kc_jubilee_honey",   name: "Jubilee Honey",    qualities: ["Wisdom", "Valor"],      emoji: "🍯" },
  { id: "kc_bellflower_syrup",name: "Bellflower Syrup", qualities: ["Cunning", "Valor"],     emoji: "💜" },
  { id: "kc_porcelain_plums", name: "Porcelain Plums",  qualities: ["Honor", "Fortune"],     emoji: "🫐" },
  { id: "kc_golden_marzipan", name: "Golden Marzipan",  qualities: ["Valor", "Honor"],       emoji: "⭐" },
  { id: "kc_midnight_truffle",name: "Midnight Truffle", qualities: ["Radiance", "Mirth"],    emoji: "🍫" },
  { id: "kc_court_custard",   name: "Court Custard",    qualities: ["Glamour", "Cunning"],   emoji: "🍮" },
  { id: "kc_ribbon_candy",    name: "Ribbon Candy",     qualities: ["Majesty", "Serenity"],  emoji: "🍬" },
  { id: "kc_swanberry_jam",   name: "Swanberry Jam",    qualities: ["Cunning", "Radiance"],  emoji: "🦢" },
  { id: "kc_prince_pears",    name: "Prince Pears",     qualities: ["Serenity", "Honor"],    emoji: "🍐" },
  { id: "kc_blackbird_pie",   name: "Blackbird Pie",    qualities: ["Cunning", "Mirth"],     emoji: "🥧" },
  { id: "kc_glass_sugar",     name: "Glass Sugar",      qualities: ["Serenity", "Glamour"],  emoji: "💎" },
  { id: "kc_coronation_cream",name: "Coronation Cream", qualities: ["Fortune", "Cunning"],   emoji: "🎂" },
];
