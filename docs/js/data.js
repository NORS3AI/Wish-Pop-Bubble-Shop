...
const VILLAIN_MAGIC = {
  Vanity:  "#d94fb0",   // glamour magenta — the mirror's flattery
  Envy:    "#2caf6e",   // emerald — green with jealousy
  Sorcery: "#8341cf",   // royal violet — her dark art
  Slumber: "#5f7be0",   // periwinkle — the sleeping curse
  Glamour: "#d4a63f",   // gold — her radiant beauty spell
  Frost:   "#57c3e6",   // ice blue — a cold, cold heart
  Poison:  "#8ec63f",   // apple green — the hazard she hides in the brew
};
...
// reads Vanity/Envy/Frost/etc. and the balance is identical.
const QUEEN_INGREDIENTS = [
  { id: "q_rubyapple",   name: "Ruby Apple",     qualities: ["Sorcery", "Vanity"],  emoji: "🍎" },
  { id: "q_sourapple",   name: "Sour Apple",     qualities: ["Envy", "Vanity"],     emoji: "🍏" },
  { id: "q_amethyst",    name: "Amethyst",       qualities: ["Vanity", "Sorcery"],  emoji: "💜" },
  { id: "q_darkcrystal", name: "Dark Crystal",   qualities: ["Slumber", "Envy"],    emoji: "🔮" },
  { id: "q_violetorb",   name: "Violet Orb",     qualities: ["Slumber", "Glamour"], emoji: "🟣" },
  { id: "q_hexgem",      name: "Hex Gem",        qualities: ["Glamour", "Envy"],    emoji: "💎" },
  { id: "q_cursedring",  name: "Cursed Ring",    qualities: ["Frost", "Vanity"],    emoji: "💍" },
  { id: "q_onyxbeads",   name: "Onyx Beads",     qualities: ["Envy", "Frost"],      emoji: "📿" },
  { id: "q_nightvial",   name: "Nightshade Vial",qualities: ["Sorcery", "Glamour"], emoji: "🧪" },
...
// copyQ = the hidden THIRD quality a Copycat copy reveals (see the copycat mode). Only
// used in copycat rounds; ignored everywhere else. Chosen to differ from the base two.
const COURTYARD_INGREDIENTS = [
  { id: "kc_pumpkin_nectar",  name: "Pumpkin Nectar",   qualities: ["Mirth", "Serenity"],    emoji: "🎃", copyQ: "Fortune" },
  { id: "kc_slipper_sugar",   name: "Slipper Sugar",    qualities: ["Majesty", "Wisdom"],    emoji: "👠", copyQ: "Glamour" },
  { id: "kc_frogmint",        name: "Frogmint",         qualities: ["Radiance", "Serenity"], emoji: "🌿", copyQ: "Mirth" },
  { id: "kc_crownberries",    name: "Crownberries",     qualities: ["Glamour", "Majesty"],   emoji: "👑", copyQ: "Radiance" },
  { id: "kc_moon_cream",      name: "Moon Cream",       qualities: ["Valor", "Radiance"],    emoji: "🌙", copyQ: "Wisdom" },
  { id: "kc_rose_cordial",    name: "Rose Cordial",     qualities: ["Honor", "Wisdom"],      emoji: "🌹", copyQ: "Serenity" },
  { id: "kc_peacock_pepper",  name: "Peacock Pepper",   qualities: ["Fortune", "Glamour"],   emoji: "🦚", copyQ: "Cunning" },
  { id: "kc_velvet_figs",     name: "Velvet Figs",      qualities: ["Mirth", "Fortune"],     emoji: "🍇", copyQ: "Glamour" },
  { id: "kc_jubilee_honey",   name: "Jubilee Honey",    qualities: ["Wisdom", "Valor"],      emoji: "🍯", copyQ: "Honor" },
  { id: "kc_bellflower_syrup",name: "Bellflower Syrup", qualities: ["Cunning", "Valor"],     emoji: "💜", copyQ: "Fortune" },
  { id: "kc_porcelain_plums", name: "Porcelain Plums",  qualities: ["Honor", "Fortune"],     emoji: "🫐", copyQ: "Majesty" },
  { id: "kc_golden_marzipan", name: "Golden Marzipan",  qualities: ["Valor", "Honor"],       emoji: "⭐", copyQ: "Majesty" },
  { id: "kc_midnight_truffle",name: "Midnight Truffle", qualities: ["Radiance", "Mirth"],    emoji: "🍫", copyQ: "Cunning" },
  { id: "kc_court_custard",   name: "Court Custard",    qualities: ["Glamour", "Cunning"],   emoji: "🍮", copyQ: "Mirth" },
  { id: "kc_ribbon_candy",    name: "Ribbon Candy",     qualities: ["Majesty", "Serenity"],  emoji: "🍬", copyQ: "Radiance" },
  { id: "kc_swanberry_jam",   name: "Swanberry Jam",    qualities: ["Cunning", "Radiance"],  emoji: "🦢", copyQ: "Fortune" },
  { id: "kc_prince_pears",    name: "Prince Pears",     qualities: ["Serenity", "Honor"],    emoji: "🍐", copyQ: "Wisdom" },
  { id: "kc_blackbird_pie",   name: "Blackbird Pie",    qualities: ["Cunning", "Mirth"],     emoji: "🥧", copyQ: "Fortune" },
  { id: "kc_glass_sugar",     name: "Glass Sugar",      qualities: ["Serenity", "Glamour"],  emoji: "💎", copyQ: "Radiance" },
  { id: "kc_coronation_cream",name: "Coronation Cream", qualities: ["Fortune", "Cunning"],   emoji: "🎂", copyQ: "Majesty" },
];
...
const SPECIAL_CHARMS = {
  ...
  // Ice-realm only: re-freeze every thawing ingredient back to full (resets their timers).
  refreeze:{ id: "refreeze",name: "Frost Gem", emoji: "❄️", desc: "Re-freeze all thawing ingredients.", frostOnly: true },
};
// mode-only charms (copycat die, frost gem) are excluded from the normal drop/allow pools
const SPECIAL_CHARM_IDS = Object.keys(SPECIAL_CHARMS).filter(id => !SPECIAL_CHARMS[id].copycatOnly && !SPECIAL_CHARMS[id].frostOnly);
...
const COURTYARD_CUSTOMERS = [
  { id: "jester",   name: "Jasper the Jester", emoji: "🃏", location: "King's Courtyard", wishType: "c_Jest", art: "jester_smile",
    ...
    lines: ["A wish for mischief — the court could use a laugh!",
      ...
      "A dash of cunning and a giggle; I've a prank to pull at supper.",
      "Make it bubbly and absurd! Solemn courts are so dreadfully dull."] },
  { id: "knight",   name: "Brave Knight",   emoji: "🛡️", location: "King's Courtyard", wishType: "c_Joust",
    ...
    lines: ["Valor before the joust, if you'd be so kind.",
      "Steel my nerve — the tournament lists open at dawn.",
      "A charm of honor, that I might unseat the champion fairly.",
      "Courage in a cup, please — I face the Black Knight today."] },
  { id: "advisor",  name: "Royal Advisor",  emoji: "🧐", location: "King's Courtyard", wishType: "c_Counsel",
    ...
    lines: ["A touch of wisdom — His Majesty is in a mood again.",
      "Clarity, if you please — the royal ledgers won't balance themselves.",
      "Something calming and clever; I must counsel the King before noon.",
      "A wise little draught. One tires of being the only sensible soul at court."] },
  { id: "prince",   name: "Exiled Prince",  emoji: "🤴", location: "King's Courtyard", wishType: "c_Crown",
    ...
    lines: ["A taste of majesty for the long road back to my throne.",
      "Radiance befitting a crown — I'll not be exiled forever.",
      "Something regal, that the people might remember their true prince.",
      "A glow of nobility. A throne is won by bearing as much as by blade."] },
  { id: "guard",    name: "Palace Guard",   emoji: "💂", location: "King's Courtyard", wishType: "c_Watch",
    ...
    lines: ["Honor and vigilance for the long night watch, please.",
      "Keep me sharp till sunrise — the gates won't guard themselves.",
      "A steadfast brew. Nothing slips past a Palace Guard on my watch.",
      "Valor for the graveyard shift — the dungeons get restless after dark."] },
  { id: "sword",    name: "Talking Sword",  emoji: "⚔️", location: "King's Courtyard", wishType: "c_Legend",
    ...
    lines: ["Fill me with valor — I've a dragon to meet at dawn!",
      "Make me legendary! A blade is only as bold as its brew.",
      "Sharpen my spirit, not my edge — glory awaits on the morrow.",
      "A hero's draught! I intend to be sung about for centuries."] },
  { id: "noble",    name: "Disguised Noble",emoji: "🎭", location: "King's Courtyard", wishType: "c_Gala",
    ...
    lines: ["A little glamour… no one must recognize me at the gala.",
      "Something dazzling but discreet — I mustn't outshine the host. Much.",
      "A masked sort of magnificence, if you follow. Reputations are delicate.",
      "Glamour enough to turn heads, subtle enough to keep my secret."] },
  { id: "king",     name: "Cursed King",    emoji: "👑", location: "King's Courtyard", wishType: "c_Sorrow",
    ...
    lines: ["A little serenity, perhaps. No one visits a cursed king.",
      "Something to quiet the sorrow — the crown grows heavy of late.",
      "Peace in a potion; even majesty tires of its own gloom.",
      "A calm heart, if you can spare one. Curses are such lonely company."] },
  { id: "stepmother", name: "The Stepmother", emoji: "🖤", location: "King's Courtyard", wishType: "c_Spite",
    ...
    lines: ["Something glamorous for my daughters — and be quick about it.",
      "A charm to outshine that insufferable girl. You know the one.",
      "Beauty with a bite — my stepdaughter smiles far too much lately.",
      "Make my darlings the belles of the ball, whatever it takes."] },
  { id: "anastasia", name: "Anastasia", emoji: "💜", location: "King's Courtyard", wishType: "c_Vanity",
    line: "Make me dazzling — the prince simply must notice ME, not my sister.",
    lines: ["Make me dazzling — the prince simply must notice ME, not my sister.",
      "Something glamorous, and prettier than whatever Drizella's getting.",
      "A radiant charm for the ball — I intend to be the belle, thank you.",
      "Glitter me up! If that little cinder-girl thinks she'll outshine me, she's mistaken."] },
  { id: "drizella", name: "Drizella", emoji: "💚", location: "King's Courtyard", wishType: "c_Gala",
    line: "A charm for the gala — and do make it grander than Anastasia's.",
    lines: ["A charm for the gala — and do make it grander than Anastasia's.",
      "Something majestic. The prince will choose ME, obviously.",
      "Make me the finest lady at the ball — Mother expects nothing less.",
      "A dazzling brew, quickly! I won't be upstaged by my sister again."] },
  { id: "frog_prince", name: "Frog Prince", emoji: "🐸", location: "King's Courtyard", wishType: "c_Crown",
    ...
    lines: ["A taste of what I once was — before Lady Gothel turned me into… this.",
      "Something princely, please. Under these warts beats a royal heart.",
      "A little majesty — perhaps a kiss won't be needed after all.",
      "Restore some dignity to me. Ribbiting at galas is beneath a prince."] },
  { id: "beast_prince", name: "Beast Prince", emoji: "🦁", location: "King's Courtyard", wishType: "c_Sorrow",
    ...
    lines: ["Something warm. Something kind. I've quite forgotten what being human felt like.",
      "A gentle brew — the fur and fangs frighten off every kind soul.",
      "Serenity, if you please. A beast's temper is a hard thing to carry.",
      "Something tender for a monster's heart. It still remembers how to hope."] },
  { id: "rosalinda", name: "Queen Rosalinda", emoji: "🖼️", location: "King's Courtyard", wishType: "c_Vanity",
    ...
    lines: ["Normally everyone comes to see me — but lucky you, I'm here for a visit. A magic paintbrush to touch up my makeup each morning; flawless, naturally.",
      "A mirror-charm that shows only my good side. They're all my good side, but still.",
      "Make me positively radiant — more so than usual, I mean. Do keep up.",
      "A gown-glamour that never wrinkles nor fades. A queen must never repeat a look."] },
  { id: "gothel", name: "Lady Gothel", emoji: "🧙‍♀️", location: "King's Courtyard", wishType: "c_Enchant", alwaysBoss: true,
    ...
    lines: ["A potion for my enchantments, darling — I do so hate when my spells start to… fade.",
      "Something to keep me eternally young. Flowers wilt; I refuse to.",
      "A draught of glamour — and mind you don't skimp, or you'll regret it.",
      "Enchantment, and make it potent. My tower's magic won't renew itself."] },
];
...
const REALMS = [
  ...
  { id: "courtyard", name: "King's Courtyard",    icon: "🏰", tagline: "Jesters, knights, and an enchanted (grumpy) crown.", eventsNeeded: 8, reqBonus: 5,
    ...
    specialChance: 0.28, vipChance: 0.07 },
...
const COSMETICS = {
  ...
  familiar: [
    ...
    { id: "pet_frog",     name: "Frog",     chip: "🐸", faces: 3 },
    { id: "pet_sheep",    name: "Sheep",    chip: "🐑", faces: 3 },
    { id: "pet_cat",      name: "Cat",      chip: "🐱", faces: 3 },
    { id: "pet_squirrel", name: "Squirrel", chip: "🐿️", faces: 3 },
    { id: "pet_crow",     name: "Crow",     chip: "🐦‍⬛", faces: 3 },
